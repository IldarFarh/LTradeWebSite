...
function widgEditor(replacedTextareaID)
{
	...
	this.theContainer.className = "widgContainer row";
	
	this.theIframe.id = this.theTextarea.id + "WidgIframe";
	this.theIframe.className = "widgIframe col-xs-12";
...
function widgToolbar(theEditor)
{
	...
	for (var i = 0; i < widgToolbarItems.length; i++)
	{
		switch (widgToolbarItems[i])
		{
			...
			case "hyperlink":
				this.addButton(this.theList.id + "ButtonLink", "widgButtonLink", "fa fa-link", "link");
				
				break;
				
			case "unorderedlist":
				this.addButton(this.theList.id + "ButtonUnordered", "widgButtonUnordered", "fa fa-list-ul", "insertunorderedlist");
			...
			case "image":
				this.addButton(this.theList.id + "ButtonImage", "widgButtonImage", "fa fa-picture-o", "image");
				
				break;
				
			case "htmlsource":
				this.addButton(this.theList.id + "ButtonHTML", "widgButtonHTML", "fa fa-code", "html");
...
widgToolbar.prototype.addButton = function(theID, theLabel, theFa, theAction)
{
...
widgToolbar.prototype.disable = function()
{
	...
	this.theList.className += " disabled";
